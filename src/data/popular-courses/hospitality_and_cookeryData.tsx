...
export const hospitality_and_cookeryDummyData = {
  ...
  CookeryCoursesSectionTwo: {
    left: {
      ...
      text: `Over the years, cookery has been at the cornerstone of society by serving quality of food and promoting an environment for conversation and thought.
        ...
        If you have a passion for cookery or get excited at the thought of creating your own culinary creations, then studying in Global can give you an opportunity to develop your cooking skills under the guidance of the world’s best chefs.`,
    },
    right: {
      img: cookImg,
    },
  ...
  CookeryCoursesSectionFour: {
    title: `FAQs for Cookery Courses in Global`,
    data: [
      {
        title: `What are the benefits of studying cookery courses in Global for international students?`,
        text: `Studying cookery courses in Global offers a blend of quality education, diverse culinary exposure, and a chance to experience Globaln culture.`,
      },
      {
        title: `Are there specific entry requirements for international students interested in cookery courses in Global? `,
        text: `Yes, international students interested in cooking courses in Global need to meet the general admission requirements of the chosen educational institution.`,
      },
      {
        title: `What types of cookery courses are available for international students in Global?`,
        text: `Global offers a wide range of cooking courses, including certificate, diploma, and degree programs, catering to various skill levels and interests.`,
      },
      {
        title: `Do I need any prior experience to enrol in a cookery course in Global?`,
