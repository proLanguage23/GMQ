...
import NursingOne1 from "@/assets/course/NursingOne1.png";
import NursingTwo1 from "@/assets/course/NursingTwo1.png";
import NursingFour1 from "@/assets/course/NursingFour1.png";
...
import one_nurse from "@/assets/course/new/nursing/one_nurse.svg";
...
<br />
        <ul>
            ...
            <li>Graduate Degree &ndash; Masters of Science (MSc.), The Master of Nursing Science (MNSc).</li>
            <li>Doctoral Degree &ndash; Doctor of Philosophy (Ph.D.).</li>
  ...
  NursingSectionFour: {
    ...
    right: {
      ...
      text: `<p>This prepares for your future role as a Registered Nurse in a health care environment. Subjects include, but are not limited to health assessment, physiology, legal and professional issues, principles of research etc.</p>

        <br />
        
        <p><strong>Nursing Course Duration</strong></p>
        
        <p>3 years&rsquo; full time or equivalent part-time to complete Bachelor of Nursing</p>
        
        <br />
        
        <p><strong>Study Nursing Eligibility Requirements</strong></p>
        
        <ul>
            <li>Academic: Completion of Year 12 or Overseas Equivalent</li>
            <li>English: Academic IELTS score of 7.0 overall or equivalent</li>
        </ul>
        
        <p><em>*Institutions or universities may require a higher or lower IELTS score</em></p>`,
      btn: {
        text: `read more`,
        href: `#`,
      },
  ...
  NursingSectionFive: {
    ...
    right: {
      ...
      text: `<p>Specially designed for graduates of any Bachelor of Nursing degree to learn how to work with other healthcare professionals toward providing patient care that is of the highest quality and develop leadership skills in nursing.</p>

        <br />
        
        <p><strong>Course Duration</strong></p>
        
        <p>2 years of full-time or four years of part-time study to complete Master of Nursing</p>
        ...
        <ul>
            <li>Academic: Completion of relevant Bachelor degree or equivalent</li>
            <li>English: Academic IELTS score of 7.0 with no band lower than 7.0 or equivalent</li>
        </ul>
  ...
  NursingSectionSix: {
    ...
    right: {
      ...
      text: `<p>Become an Enrolled Nurse doing Diploma of Nursing in 12 to 18 months by international students in Australia. The Diploma course will teach you the basic skills and knowledge needed to work under a Registered Nurse. Through this course you will be able to work in a variety of nurse settings, and/or you can continue studying to complete a Bachelor of Nursing and get credits towards it.</p>
        ...
        <p>1.5 to 2 years to complete Diploma of Nursing</p>
        ...
        <ul>
            <li>Academic: Completion of Year 12 or Overseas Equivalent</li>
            <li>English: Academic IELTS score of 7 overall with no band lower than 7 or equivalent</li>
        </ul>
        <br />
        <br />
    ...
    data: [
      {
        ...
        text: `<p>Australia had always taken pride for providing high quality education. Australian Nurse Programs had been meticulously developed to impart theoretical knowledge and hone practical skills required in delivering excellent healthcare services.</p>
                ...
                <p>High demands for qualified nurses and related healthcare services, as reflected in Skilled Occupations List, is one of the driving factors for its popularity. Relevant educational background, work experiences maybe counted towards application of Permanent Residency.</p>
                ...
                <p>It is good to note that most international students can work for up to forty (40) hours every two weeks during semester and unrestricted hours during any scheduled course break and public holidays.</p>
      ...
      },
      {
        ...
        text: `<p>Nursing is a profession focused on the care of individuals and communities with scientific knowledge, trainings and skills developed through extensive education and career. Nurses are focused in promoting health and prevention of illness and injury, facilitation of healing and optimization of health and of life.</p>

                <br />
                
                <p>Nurses work in a diverse range of settings including hospitals, community settings, general practices, prisons, homes and residential settings.</p>
                `,
      },
      {
        ...
        text: `<p>GMQ Global proudly represents the best Australian education providers, assisting students with visa and migrations processes, making personalised education pathway and worry free experience. Sample of the Nursing degrees and qualifications offered:</p>
                ...
                <ul>
                    ...
                    <li>Return to Practice for overseas trained nurse / IRON (Initial Registration for Overseas Nurses)</li>
                    <li>Master of Nursing (with specialisation)</li>
                </ul>
                `,
      },
      {
        title: `Entry Requirements`,
        text: `<p>Here are some of the international students requirements in securing student visa. Alternatively, you can contact our education consultants for worry free process.</p>
      ...
      },
      {
        ...
        text: `<p>Overseas nurses having different backgrounds and practice are prepared thoroughly to be integrated into the Australian workforce via Bridging Program for Nurses or popularly known as IRON (Initial Registration for Overseas Nurses). The program helps build confidence and increases the employability of overseas nurses.</p>
                ...
                <p>Nurses cover a wide range of settings, from hospitals, private clinics, rural/community centres, to schools, prisons, rehabilitation centres and the likes. There are opportunities for nurses to explore other field such as in Aged Care, Education, Neonatal Care and Community Health.</p>
                `,
      },
      {
