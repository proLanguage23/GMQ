...
function AppSliderBannerItem({
  ...
  return (
    <>
    <div className={`relative md:h-[460px] sm:h-[300px] h-auto overflow-hidden z-0 hidden md:block  ${class_name}`}>
      <Container>
        <div className={`md:w-1/2 sm:w-2/3 w-full flex justify-center items-center md:h-[460px]  sm:h-[300px] h-auto py-5 sm:py-0 ${class_name}`}>
