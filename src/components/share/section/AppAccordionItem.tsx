    ...
    >
      ...
      <div className="accordionHeader">
        ...
        >
          ...
          <div
            className={`icon w-9 h-9 rounded-full flex justify-center items-center group-hover:bg-primary group-hover:text-white transition-all border-2 duration-200 ease-out group-hover:rotate-180 ${
              value === obj[Object.keys(obj)[0]]
