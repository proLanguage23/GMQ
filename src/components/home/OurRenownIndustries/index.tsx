            ...
            {data?.map((item: any, key: any) => (
              <div
                ...
                className={`cursor-pointer rounded-lg hover:opacity-90 overflow-hidden transition-all ease-in-out duration-300 border p-3 md:p-7 h-full relative ${
                  item?.id === "1" && "md:row-start-1 md:row-end-3"
                }
                      ${
                        item?.id === "3" &&
                      ...
                      ${
                        item?.id === "4" &&
                        "md:col-start-2 md:row-start-2 md:row-end-4"
                      }
              ...
              >
                ...
                <AppBgImg BgImg={item?.img} alt={title} class_name="group-hover:scale-110 transition-all ease-in-out duration-500" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
              </div>
            ))}
          </div>
        </div>
